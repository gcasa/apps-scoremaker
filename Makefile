...
BUILD_DIR := build
SRC_DIR := src
SOURCES := $(SRC_DIR)/main.m $(SRC_DIR)/AppDelegate.m $(SRC_DIR)/ScoreMakerDocumentController.m $(SRC_DIR)/ScoreMakerDocument.m $(SRC_DIR)/MidiParser.m $(SRC_DIR)/MusicXMLParser.m $(SRC_DIR)/ScorefileParser.m $(SRC_DIR)/ScoreModel.m $(SRC_DIR)/ScoreView.m $(SRC_DIR)/PlaybackMonitorView.m
